...
export const MySideBar = () => {
  ...
  return (
    <div className="w-[450px] bg-gradient-to-br from-[#0A192F] via-[#112240] to-[#1B2C4F] border-l border-blue-400/10 flex flex-col p-8 gap-8 overflow-auto shadow-[0_0_45px_-15px_rgba(66,153,225,0.4)]">
        ...
        {myPrivateKeys.length ? (
          ...
          <div className="h-full flex items-center justify-center p-8">
            <div className="text-center space-y-2">
              <p className="text-purple-200/60 text-sm">No private keys yet</p>
